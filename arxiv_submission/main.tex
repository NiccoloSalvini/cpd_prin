...
\author{
    ...
    Niccolò Salvini\thanks{University of Florence. E-mail: \texttt{niccolo.salvini@unitus.it}}
}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{hotel_price_distribution.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{moran_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lisa_map.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{spi_map.pdf}
